...
//1
#define OAUTH_KEY    (@"WVW0NJHT5NZHCPHVZEOTOHBOHYZ3IU0QAQQR1X13YOOVG5CM")
#define OAUTH_SECRET (@"YV3P0UKFNDAQH2ZSV234TYYY13LU10VKUMJGDMEFHXYGE4N3")

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#define REDIRECT_URL @"http://www.melbourneguidedawg.com"
